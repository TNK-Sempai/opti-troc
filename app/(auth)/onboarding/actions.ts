      ...
      await resend.emails.send({
        ...
        html: `
          ...
          <body>
            <div class="container">
              <div class="header">
                <h1 style="color: #1a2332;">Profil complété avec succès !</h1>
              </div>
              
              <p>Bonjour ${profile?.first_name || profile?.contact_name},</p>
              <p>Merci d'avoir complété votre profil sur Opti-troc !</p>
              ...
              <ol>
                ...
                <li><strong>Notification par email</strong> : vous serez informé dès que votre compte est validé</li>
                <li><strong>Accès complet</strong> : créez vos annonces et commencez à vendre !</li>
              </ol>
              
              <p>Nous vous tiendrons informé par email de l'avancement.</p>
