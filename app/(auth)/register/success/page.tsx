        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div className="flex gap-3 p-4 bg-info/5 rounded-lg border border-info/20">
              ...
              <div>
                <p className="font-medium text-sm text-charcoal">Email de confirmation envoyé</p>
            ...
            <div className="flex gap-3 p-4 bg-warning/5 rounded-lg border border-warning/20">
              ...
              <div>
                <p className="font-medium text-sm text-charcoal">Validation en cours</p>
                <p className="text-sm text-dark-grey mt-1">
          ...
          <div className="pt-4 border-t">
            <h3 className="font-medium text-sm text-charcoal mb-2">Prochaines étapes :</h3>
            <ol className="space-y-2 text-sm text-dark-grey">
